...
class BatteryBadBatteryPacks(Plugin):
    ...
    def __init__(self):
        ...
        Plugin.__init__(self, 'Check the number of attached defective external battery packs')
    ...
    def run(self):
        ...
        output = Output(f'There are currently {defective} external batteries defective')
